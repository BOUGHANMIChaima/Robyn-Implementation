...
robyn_directory <- "L:/ExpandedBM/Robyn & Meridian/TEst badoit"
...
InputCollect <- robyn_inputs(
  ...
  dep_var = "VOL.TOT", # there should be only one dependent variable
  dep_var_type = "revenue", # "revenue" (ROI) or "conversion" (CPA)
  prophet_vars = c("trend", "season","holiday"), # "trend","season", "weekday" & "holiday"
  prophet_country = "FR", # input country code. Check: dt_prophet_holidays
 ...
 #   "Dummy_9",
 #   "Dummy_10"),
 # ), # force variables in context_vars or organic_vars to be categorical
 #window_start = "2016-01-01", on considète toute la période 
...
hyperparameters <- list(
  ...
  COR.B21_alphas = c(0.5, 3), # example bounds for alpha
  COR.B21_gammas = c(0.3, 1), # example bounds for gamma
  COR.B21_thetas = c(0, 0.3),
  
  COR.B22_alphas = c(0.5, 3), # example bounds for alpha
  COR.B22_gammas = c(0.3, 1), # example bounds for gamma
  COR.B22_thetas = c(0, 0.3),
  
  AQD.BUD_alphas = c(0.5, 3), # example bounds for alpha
  AQD.BUD_gammas = c(0.3, 1), # example bounds for gamma
  AQD.BUD_thetas = c(0, 0.3),
  
  AQD.EB8_alphas = c(0.5, 3), # example bounds for alpha
  AQD.EB8_gammas = c(0.3, 1), # example bounds for gamma
  AQD.EB8_thetas = c(0, 0.3),
  
  AQD.P19B_alphas = c(0.5, 3), # example bounds for alpha
  AQD.P19B_gammas = c(0.3, 1), # example bounds for gamma
  AQD.P19B_thetas = c(0, 0.3),
  
  AQD.E19B_alphas = c(0.5, 3), # example bounds for alpha
  AQD.E19B_gammas = c(0.3, 1), # example bounds for gamma
  AQD.E19B_thetas = c(0, 0.3),
  
  AQD.E21B_alphas = c(0.5, 3), # example bounds for alpha
  AQD.E21B_gammas = c(0.3, 1), # example bounds for gamma
  AQD.E21B_thetas = c(0, 0.3),
  
  AQD.TB8_alphas = c(0.5, 3), # example bounds for alpha
  AQD.TB8_gammas = c(0.3, 1), # example bounds for gamma
  AQD.TB8_thetas = c(0, 0.3),
  
  AQD.TB9_alphas = c(0.5, 3), # example bounds for alpha
  AQD.TB9_gammas = c(0.3, 1), # example bounds for gamma
  AQD.TB9_thetas = c(0, 0.3),
  
  AQD.HB8_alphas = c(0.5, 3), # example bounds for alpha
  AQD.HB8_gammas = c(0.3, 1), # example bounds for gamma
  AQD.HB8_thetas = c(0, 0.3),
  
  
  AQD.E22B_alphas = c(0.5, 3), # example bounds for alpha
  AQD.E22B_gammas = c(0.3, 1), # example bounds for gamma
  AQD.E22B_thetas = c(0, 0.3),
  
  OOA.E18B_alphas = c(0.5, 3), # example bounds for alpha
  OOA.E18B_gammas = c(0.3, 1), # example bounds for gamma
  OOA.E18B_thetas = c(0, 0.3),
  
  OOA.E19B_alphas = c(0.5, 3), # example bounds for alpha
  OOA.E19B_gammas = c(0.3, 1), # example bounds for gamma
  OOA.E19B_thetas = c(0, 0.3),
  
  OUT.A21B_alphas = c(0.5, 3), # example bounds for alpha
  OUT.A21B_gammas = c(0.3, 1), # example bounds for gamma
  OUT.A21B_thetas = c(0, 0.3),
  
  DOH.19V1B_alphas = c(0.5, 3), # example bounds for alpha
  DOH.19V1B_gammas = c(0.3, 1), # example bounds for gamma
  DOH.19V1B_thetas = c(0, 0.3),
  
  VOD.BUD_alphas = c(0.5, 3), # example bounds for alpha
  VOD.BUD_gammas = c(0.3, 1), # example bounds for gamma
  VOD.BUD_thetas = c(0, 0.3),
  
  SOC.BU1_alphas = c(0.5, 3), # example bounds for alpha
  SOC.BU1_gammas = c(0.3, 1), # example bounds for gamma
  SOC.BU1_thetas = c(0, 0.3),
  
  SOC.BU2_alphas = c(0.5, 3), # example bounds for alpha
  SOC.BU2_gammas = c(0.3, 1), # example bounds for gamma
  SOC.BU2_thetas = c(0, 0.3),
  
  SOC.BU3_alphas = c(0.5, 3), # example bounds for alpha
  SOC.BU3_gammas = c(0.3, 1), # example bounds for gamma
  SOC.BU3_thetas = c(0, 0.3),
  
  SEA.BUD_alphas = c(0.5, 3), # example bounds for alpha
  SEA.BUD_gammas = c(0.3, 1), # example bounds for gamma
  SEA.BUD_thetas = c(0, 0.3),
  
  DIG.BUD2_alphas = c(0.5, 3), # example bounds for alpha
  DIG.BUD2_gammas = c(0.3, 1), # example bounds for gamma
  DIG.BUD2_thetas = c(0, 0.3),
  
  SPO.TB8_alphas = c(0.5, 3), # example bounds for alpha
  SPO.TB8_gammas = c(0.3, 1), # example bounds for gamma
  SPO.TB8_thetas = c(0, 0.3),
  
  SPO.TB9_alphas = c(0.5, 3), # example bounds for alpha
  SPO.TB9_gammas = c(0.3, 1), # example bounds for gamma
  SPO.TB9_thetas = c(0, 0.3),
  
  OOC.E22B_alphas = c(0.5, 3), # example bounds for alpha
  OOC.E22B_gammas = c(0.3, 1), # example bounds for gamma
  OOC.E22B_thetas = c(0, 0.3),
  
  OUT.A18B_alphas = c(0.5, 3), # example bounds for alpha
  OUT.A18B_gammas = c(0.3, 1), # example bounds for gamma
  OUT.A18B_thetas = c(0, 0.3),
  
  OUT.A19B_alphas = c(0.5, 3), # example bounds for alpha
  OUT.A19B_gammas = c(0.3, 1), # example bounds for gamma
  OUT.A19B_thetas = c(0, 0.3),
  
  DOH.19V2B_alphas = c(0.5, 3), # example bounds for alpha
  DOH.19V2B_gammas = c(0.3, 1), # example bounds for gamma
  DOH.19V2B_thetas = c(0, 0.3),
...
OutputModels <- robyn_run(
  ...
  cores = NULL, # c'était NULL je l'ai chnagé # NULL defaults to (max available - 1)
  iterations = 2000, # c'était 2000##  2000 recommended for the dummy dataset with no calibration
...
print(OutputCollect)
select_model <- "5_265_3" # Pick one of the models from OutputCollect to proceed
